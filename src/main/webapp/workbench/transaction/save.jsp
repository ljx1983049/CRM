...
<body>
	...
	<form class="form-horizontal" action="workbench/transaction/save.do" method="post" role="form" id="tranFrom" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" value="031edb2d47204bbf86de9dd38212f84a" name="activityId">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" value="1b86ffeff13e4221abc8349d31359044" name="contactsId">
			</div>
		</div>
